...
const uint64_t CACHE_SIZE_IN_BYTES = 100 << 10; // 10<<10; 1 << 20 = 1 MB
const uint64_t DRAM_SIZE_IN_BYTES = 10 << 20; // 100 MB
const uint64_t SSD_SIZE_IN_BYTES = ((uint64_t)1) << 30; // 10 GB
